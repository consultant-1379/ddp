    ...
    $sqlParam = array(
        ...
        'querylist'  => array(
                            array(
                                'timecol' => 'time',
                                'whatcol' => $whatCol,
                                'tables'  => "windows_physicaldisk_details",
                                'where'   => 'windows_physicaldisk_details.serverid = %d',
...
$physicalDiskHelp = <<<EOT
    ...
    This is fetched from Physical_Disk.tsv created by Windows performance monitor.
    </p>
    The following metrics are presented:
    <ul>
    <li><b>Avg Disk Queue Length:</b> Avg. Disk Queue Length is the average number of both read and write requests that were queued for the selected disk during the sample interval.</li>
    ...
    <li><b>%Busy:</b> %Busy Time reports the percentage of time during the sample interval that the disk was busy i.e. %Busy = 100 - %Idle.</li>
    </ul>
EOT;
