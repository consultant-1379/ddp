...
public class memSar extends AllGraph {
    ...
    public void add(final Second now,final  Float memInit,final  Float swapInit) {
        ...
        this.t_freeswap.add(now, swapInit.floatValue(), do_notify()); // remove multifactor * 512 - eeicjon
        number_of_sample++;
    }
    ...
    public JFreeChart makegraph(final Second g_start, final Second g_end) {
        ...
        NumberFormat decimalformat1 = new IEEE1541Number(512); // eeicjon - bring back multifactor
