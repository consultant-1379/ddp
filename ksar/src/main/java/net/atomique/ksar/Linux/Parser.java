...
public class Parser {
    ...
    public int parse(String thisLine, String first, StringTokenizer matcher) {
         ...
         */
        if (thisLine.indexOf("kbhugused") > 0) {
            headerFound = 1;
            mysar.underaverage = 0;
        }
        ...
        if (headerFound == 1) {
            ...
            if (lastHeader.equals("kbhugfree") && thisLine.indexOf("%hugused") > 0 && statType.equals("newkhug")) {
                headerFound = 0;
                return 1;
            }
            ...
            if (statType.equals("kbhugfree") && thisLine.indexOf("%hugused") >= 0) {
                if (sarKBHUG == null) {
                    sarKBHUG = new kbhugSar(mysar);
                    if (mysar.myUI != null) {
                        sarKBHUG.addtotree(mysar.graphtree);
                    }
                    mysar.pdfList.put("LinuxkbhugSar", sarKBHUG);
                    sarKBHUG.setGraphLink("LinuxkbhugSar");
                }
                statType = "newkhug";
                return 1;
            }
        ...
        try {
            ...
            //  CPU-RHEL6      %usr %nice %sys %iowait %steal %irq %soft %guest %idle
        ...
        //  CPU-RHEL7      %usr %nice %sys %iowait %steal %irq %soft %guest %gnice %idle
            if (statType.equals("%gnice")) {
                if (mysar.underaverage == 1) {
                    return 1;
                }
                cpuSar mysarcpu = (cpuSar) mysar.cpuSarList.get(lastHeader + "-cpu");
                ...
                mysarcpu.add(now, val1, val2, val3, val4, val5, val6, val7, val8, val9, val10);
                return 1;
            }
             ...
             */
            if (statType.equals("newkhug")) { // kbhugfree kbhugused  %hugused
                val1 = new Float(lastHeader);
                val2 = new Float(matcher.nextToken());
                val3 = new Float(matcher.nextToken());
                sarKBHUG.add(now, val1, val2, val3);
                return 1;
            }
