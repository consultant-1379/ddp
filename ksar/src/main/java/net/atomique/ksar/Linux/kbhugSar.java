...
/**
 *
 * @author Piyush Chandravanshi
 */
public class kbhugSar extends AllGraph {

    public kbhugSar(kSar hissar) {
        super(hissar);
        Title = new String("KB Hug Memory Usage");
        t_free = new TimeSeries("hugfree", org.jfree.data.time.Second.class);
        mysar.dispo.put("KB hug free", t_free);
        t_used = new TimeSeries("hugused", org.jfree.data.time.Second.class);
        mysar.dispo.put("KB hug used", t_used);
        t_perc = new TimeSeries("%hugused", org.jfree.data.time.Second.class);
        mysar.dispo.put("%hug used", t_perc);
        //
    ...
    public void addtotree(DefaultMutableTreeNode myroot) {
        mynode = new DefaultMutableTreeNode(new GraphDescription(this, "LINUXKBHUG", this.Title, null));
    ...
    public JFreeChart makegraph(Second g_start, Second g_end) {
        ...
        NumberAxis numberaxis1 = new NumberAxis("hugfree");
        ...
        // used
        XYPlot subplot2;
        NumberAxis numberaxis = new NumberAxis("hugused");
        ...
        XYPlot subplot3 = new XYPlot(percset, null, new NumberAxis("%hugused"), minichart3);
        // the graph
